                            ...
                            {item?.id === 0 ? (
                                ...
                                <>
                                    {(item.level < 7 && item.rarity === 'Legend' || item.rarity !== 'Legend') && item.count > 1 && balance >= item.upgrade_price && <svg className={styles.card_upgrading} width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.3" d="M6.2 1.4001H7.6V2.8001H9V1.4001H7.6V9.77516e-05H6.2V1.4001H4.8V2.8001H6.2V1.4001ZM3.4 4.2001V2.8001H4.8V4.2001H3.4ZM3.4 4.2001V5.6001H2V4.2001H3.4ZM10.4 4.2001V2.8001H9V4.2001H10.4ZM10.4 4.2001V5.6001H11.8V4.2001H10.4Z" fill="#38c313" />
                                        ...
                                        <path opacity="0.8" d="M6.2 9.8H7.6V11.2H9V9.8H7.6V8.4H6.2V9.8H4.8V11.2H6.2V9.8ZM3.4 12.6V11.2H4.8V12.6H3.4ZM3.4 12.6V14H2V12.6H3.4ZM10.4 12.6V11.2H9V12.6H10.4ZM10.4 12.6V14H11.8V12.6H10.4Z" fill="#38c313" />
                                    </svg>}
                                    <img
